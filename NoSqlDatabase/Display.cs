 ...
 * --------------------
 * ver 1.3 : 07 Oct 15
 * - showImmutableDB method is added which is an extension method for DBFactory
 * ver 1.2 : 24 Sep 15
...
namespace Project4Starter
{
    ...
    public static class DisplayExtensions
    {
        ...
        {
            return enumElement.showElement<string, List<string>, string>();
        }
        ...
        public static string showEnumerableDB(this DBEngine<string, DBElement<string, List<string>>> db)
        {
            return db.show<string, DBElement<string, List<string>>, List<string>, string>();
        }
    }
