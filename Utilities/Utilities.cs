 ...
 * --------------------
  * ver 1.2 : 18 Nov 2015
 * - added methods which was used in Project 2 which are used as display aid
 * ver 1.1 : 24 Oct 2015
...
namespace Project4Starter
{
    static public class Utilities
    {
        ...
        public static void endofTest(this string aString, char equal = '=')
        {
            Console.Write("\n {0} {1} {2}", new string(equal, aString.Length), aString, new string(equal, aString.Length));
        }

        public static void demarcation(this string aString, char symbol = '_')
        {
            Console.Write("\n {0}", new string(symbol, 30));
        }
